...
<section class="section" id="popular">
    <div class="container">
        ...
        {{-- @if($travel_package->galleries->isNotEmpty())
                                ...
                                <img src="{{Storage::url($travel_package->galleries->first()->images) }}" class="popular__img" alt="Package Image" >
        @else
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="{{ asset('frontend/assets/img/backg/Travel insurance-bro.svg') }}" alt="" />
            </div>
        </div>
                ...
                @foreach($inspirations as $inspiration)
                    <article class="popular__card swiper-slide">
                        <a href="{{ $inspiration->url }}" target="_blank">
                            <div class="popular__data">
                                <h2 class="popular__price">
                                    <span>Visit</span>->{{ $inspiration->title }}
                                </h2>
